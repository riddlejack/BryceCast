...
export const roadAmericaSections: TrackSectionAnchorSet = {
  ...
  sections: [
    { familyId: 'ra-sf-i1b', sectionName: 'SF to I1B', label: 'S/F→I1B', startLoop: 'SF', endLoop: 'I1B', startT: 0.0965, endT: 0.1551 },
    { familyId: 'ra-i1b-i1', sectionName: 'I1B to I1', label: 'I1B→I1', startLoop: 'I1B', endLoop: 'I1', startT: 0.1551, endT: 0.1654 },
    { familyId: 'ra-i1-i2', sectionName: 'I1 to I2', label: 'I1→I2', startLoop: 'I1', endLoop: 'I2', startT: 0.1654, endT: 0.2205 },
    { familyId: 'ra-i2-i3', sectionName: 'I2 to I3', label: 'I2→I3', startLoop: 'I2', endLoop: 'I3', startT: 0.2205, endT: 0.26 },
    { familyId: 'ra-i3-i3a', sectionName: 'I3 to I3A', label: 'I3→I3A', startLoop: 'I3', endLoop: 'I3A', startT: 0.26, endT: 0.3243 },
    { familyId: 'ra-i3a-i4', sectionName: 'I3A to I4', label: 'I3A→I4', startLoop: 'I3A', endLoop: 'I4', startT: 0.3243, endT: 0.3719 },
    { familyId: 'ra-i4-i4a', sectionName: 'I4 to I4A', label: 'I4→I4A', startLoop: 'I4', endLoop: 'I4A', startT: 0.3719, endT: 0.4151 },
    { familyId: 'ra-i4a-i5', sectionName: 'I4A to I5', label: 'I4A→I5', startLoop: 'I4A', endLoop: 'I5', startT: 0.4151, endT: 0.4499 },
    { familyId: 'ra-i5-i6', sectionName: 'I5 to I6', label: 'I5→I6', startLoop: 'I5', endLoop: 'I6', startT: 0.4499, endT: 0.4846 },
    { familyId: 'ra-i6-i7', sectionName: 'I6 to I7', label: 'I6→I7', startLoop: 'I6', endLoop: 'I7', startT: 0.4846, endT: 0.532 },
    { familyId: 'ra-i7-i8', sectionName: 'I7 to I8', label: 'I7→I8', startLoop: 'I7', endLoop: 'I8', startT: 0.532, endT: 0.5953 },
    { familyId: 'ra-i8-i9', sectionName: 'I8 to I9', label: 'I8→I9', startLoop: 'I8', endLoop: 'I9', startT: 0.5953, endT: 0.6304 },
    { familyId: 'ra-i9-i10', sectionName: 'I9 to I10', label: 'I9→I10', startLoop: 'I9', endLoop: 'I10', startT: 0.6304, endT: 0.6859 },
    /* Concatenated-name family → fingerprinted sub-section I11→I11B (len 0.2566 mi). */
    { familyId: 'ra-i11-i11b', sectionName: 'I10 to I11 I11 to I11B', label: 'I11→I11B', startLoop: 'I11', endLoop: 'I11B', startT: 0.7569, endT: 0.8209 },
    /* Concatenated-name family → fingerprinted sub-section I13→I13A (len 0.1085 mi). */
    { familyId: 'ra-i13-i13a', sectionName: 'I11B to I12 I12 to I13 I13 to I13A I13A to I14 I14 to I15C I15C to I15', label: 'I13→I13A', startLoop: 'I13', endLoop: 'I13A', startT: 0.9365, endT: 0.9636 },
    { familyId: 'ra-i15-sf', sectionName: 'I15 to SF', label: 'I15→S/F', startLoop: 'I15', endLoop: 'SF', startT: 0.05, endT: 0.0965 }
  ]
};

...
export const midOhioSportsCarCourseSections: TrackSectionAnchorSet = {
  ...
  sections: [
    { familyId: 'mid-t1', sectionName: 'Turn 1', label: 'Turn 1', startT: 0.7762, endT: 0.8325 },
    { familyId: 'mid-t1a', sectionName: 'Turn 1A', label: 'Turn 1A', startT: 0.8325, endT: 0.8972 },
    { familyId: 'mid-t1b', sectionName: 'Turn 1B', label: 'Turn 1B', startT: 0.8972, endT: 0.9464 },
    { familyId: 'mid-t2', sectionName: 'Turn 2', label: 'Turn 2', startT: 0.9464, endT: 0.0236 },
    { familyId: 'mid-t3', sectionName: 'Turn 3', label: 'Turn 3', startT: 0.0236, endT: 0.1417 },
    { familyId: 'mid-bs', sectionName: 'Back Stretch', label: 'Back stretch', startT: 0.1417, endT: 0.2333 },
    { familyId: 'mid-t4', sectionName: 'Turn 4', label: 'Turn 4', startT: 0.2333, endT: 0.2907 },
    { familyId: 'mid-t5', sectionName: 'Turn 5', label: 'Turn 5', startT: 0.2907, endT: 0.3374 },
    { familyId: 'mid-t67', sectionName: 'Turn 6/7', label: 'Turns 6/7', startT: 0.3374, endT: 0.3999 },
    { familyId: 'mid-t8', sectionName: 'Turn 8', label: 'Turn 8', startT: 0.3999, endT: 0.4269 },
    { familyId: 'mid-t9', sectionName: 'Turn 9', label: 'Turn 9', startT: 0.4269, endT: 0.4948 },
    { familyId: 'mid-t10', sectionName: 'Turn 10', label: 'Turn 10', startT: 0.4948, endT: 0.5625 },
    { familyId: 'mid-t11', sectionName: 'Turn 11', label: 'Turn 11', startT: 0.5625, endT: 0.6213 },
    { familyId: 'mid-t12', sectionName: 'Turn 12', label: 'Turn 12', startT: 0.6213, endT: 0.6622 },
    { familyId: 'mid-t12c', sectionName: 'Turn 12C', label: 'Turn 12C', startT: 0.6622, endT: 0.6776 },
    { familyId: 'mid-t13', sectionName: 'Turn 13', label: 'Turn 13', startT: 0.6776, endT: 0.7135 }
  ]
};

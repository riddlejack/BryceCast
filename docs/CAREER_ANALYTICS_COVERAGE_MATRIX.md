...
Generated: 2026-09-10T22:28:50.492Z
...
| INDY NXT | 2026 | 17 | 79 | 406 | 45 | 61/79 | 406/406 | 406/406 | 17 | 41 |
...
- Lap samples: source availability exception, not a priority gap. INDY NXT official Race Lap Chart PDFs are imported for all 45 completed race sessions: 33 charts fully parsed and 12 clean partial visible-sample imports; residual partials preserve explicit missing car-lap or result/chart conflict diagnostics without guessing terminal or conflict laps.
...
- Lap samples: partial. 45/45 completed race sessions have lap-chart samples; 45 completed race sessions: 33 charts fully parsed and 12 clean partial visible-sample imports.
- INDY NXT section data: partial. 177/178 comparable sessions have both official Top Section Times and Section Results metrics. Aggregate combined qualifying rows, future schedule-only sessions, canceled sessions, and official no-row reports are excluded. Report parser cross-check: 179/179 comparable Top Section reports parsed; 178/179 comparable Section Results reports parsed. True held-outs: session_indy_nxt_2024_6325 (official_pdf_corrupt_or_truncated).

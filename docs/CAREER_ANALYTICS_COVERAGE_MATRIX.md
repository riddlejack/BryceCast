...
Generated: 2026-07-19T20:51:07.282Z
...
| --- | ---: | ---: | ---: | --- | --- |
| Castrol Toyota Formula Regional Oceania Championship | 2024 | 5 | 52 | none | gap_froc_2024_round_4_date_conflict, gap_froc_2024_session_times_missing, gap_froc_2024_start_positions_partial |
...
| INDY NXT | 2024, 2025, 2026 | 45 | 213 | none | gap_indy_nxt_qualifying_lap_reports |
...
| INDY NXT | complete | complete | complete | complete | partial | complete | unavailable | partial | partial | complete | complete | complete | complete | unavailable | blocked |
...
| Formula Ford | 2020 | 7 | 46 | 762 | 14 | 46/46 | 755/762 | 0/762 | 24 | 46 |
...
| INDY NXT | 2026 | 17 | 79 | 311 | 45 | 61/79 | 311/311 | 311/311 | 13 | 41 |
...
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Castrol Toyota Formula Regional Oceania Championship | 2024 | none | complete | complete | complete | partial | partial | complete | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable | unavailable | blocked |
...
| Formula Ford | 2020 | lap_samples | complete | complete | complete | partial | complete | complete | complete | partial | unavailable | partial | unavailable | unavailable | unavailable | unavailable | blocked |
...
| INDY NXT | 2024 | none | complete | complete | complete | complete | partial | complete | unavailable | partial | partial | complete | complete | complete | complete | unavailable | blocked |
| INDY NXT | 2025 | none | complete | complete | complete | complete | partial | complete | unavailable | partial | complete | complete | complete | complete | complete | unavailable | blocked |
| INDY NXT | 2026 | none | complete | complete | complete | complete | partial | complete | unavailable | partial | complete | complete | complete | complete | complete | unavailable | blocked |
...
| Formula Ford | 2020 | Champion of Brands 2020 | RACE 11 (session_formula_ford_2020_champion_brands_race_11) | race | lap_samples:partial |
| Formula Ford | 2020 | Champion of Brands 2020 | RACE 5 (session_formula_ford_2020_champion_brands_race_5) | race | lap_samples:partial |
...
| Formula Ford | 2020 | BRSCC National FF1600 2020 - Oulton Park | RACE 1 (session_formula_ford_2020_national_oulton_park_race_1) | race | lap_samples:partial |
| Formula Ford | 2020 | BRSCC National FF1600 2020 - Oulton Park | RACE 8 (session_formula_ford_2020_national_oulton_park_race_8) | race | lap_samples:partial |
...
| Formula Ford | 2020 | Walter Hayes Trophy 2020 | GRAND FINAL (session_formula_ford_2020_wht_grand_final) | race | lap_samples:partial |
...
| Formula Ford | 2020 | Walter Hayes Trophy 2020 | LAST CHANCE RACE (session_formula_ford_2020_wht_last_chance_race) | race | lap_samples:blocked |
...
| Formula Ford | 2020 | Walter Hayes Trophy 2020 | SEMI FINAL 1 (session_formula_ford_2020_wht_semi_final_1) | race | lap_samples:blocked |
| Formula Ford | 2020 | Walter Hayes Trophy 2020 | SEMI FINAL 2 (session_formula_ford_2020_wht_semi_final_2) | race | lap_samples:partial |

## Recommended Patch Order

1. publish_indy_nxt_dashboard_readiness: INDY NXT active source-backed detail blockers are closed or explicitly source-bounded. Publish the production-safe analytics list and caveats so BryceCast UI work can start from the stable official/API/PDF dataset.
2. resolve_or_preserve_gb3_2022_source_broken_rows: GB3 2021 TSL PDFs and GB3 2022 JSON expose different detail categories; after preserving that source-family split, the remaining hard GB3 gap is the official 2022 session 1248 JSON 404.
3. harden_formula_ford_lap_sample_scope: Formula Ford 2020 grid/start rows are now complete for source-matchable official event-book rows, with seven source-asymmetry holdouts preserved explicitly. The remaining active Formula Ford priority is deciding whether official lap-analysis pages justify expanding beyond the current Bryce-only lap samples.
...
- Grid/start positions: source availability exception, not a priority gap. FROC 2024 official Toyota grid tabs, linked grid PDFs, and official Toyota articles backfill every race grid row the source family exposes with enough specificity. The remaining Race 2 tail rows are held out because the official Race 2 narratives identify only the reverse/top-eight rows plus one direct P16 statement, without a complete race-specific tail grid.
...
- Lap samples: unavailable. 0 sessions have lap samples.
...
- Grid/start positions: partial. 755/762 race/heat rows have gridPosition or startPosition.
...
- Incidents/cautions: unavailable. 0 sessions have official incident/caution rows.
- Racecraft summary: unavailable. 0 race sessions have official most-improved/racecraft summary rows.
- Pit-stop counts: unavailable. 0/762 race/heat result rows have pit-stop counts.
- Detailed pit context: unavailable.
- Derived benchmarks: blocked. 0 non-report derived metrics exist for this series. Teammate/field-strength analytics are not production-ready yet.
...
- Lap samples: source availability exception, not a priority gap. INDY NXT official Race Lap Chart PDFs are imported for all 41 completed race sessions: 31 charts fully parsed and 10 clean partial visible-sample imports; residual partials preserve explicit missing car-lap or result/chart conflict diagnostics without guessing terminal or conflict laps.
...
- Exact session windows: partial. 135/213 physical sessions have clock-time starts; 213/213 have at least date-level starts; 78 sessions are source-unavailable exact windows after official source review.
- Official weather/track conditions: unavailable. 0/213 sessions have official weather/track-condition observations.
- Lap samples: partial. 41/41 completed race sessions have lap-chart samples; 41 completed race sessions: 31 charts fully parsed and 10 clean partial visible-sample imports.
- INDY NXT section data: partial. 161/162 comparable sessions have both official Top Section Times and Section Results metrics. Aggregate combined qualifying rows, future schedule-only sessions, canceled sessions, and official no-row reports are excluded. Report parser cross-check: 163/163 comparable Top Section reports parsed; 162/163 comparable Section Results reports parsed. True held-outs: session_indy_nxt_2024_6325 (official_pdf_corrupt_or_truncated).

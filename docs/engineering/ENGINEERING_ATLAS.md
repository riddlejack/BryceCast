...
BryceCast treats source eligibility as part of each metric. The [data-permissions contract](../publication/DATA_PERMISSIONS.md) separates analysis, redistribution, and operational access. The [source inventory](../archive/source-research/SOURCE-INVENTORY.md), [analytics source audit](../archive/audits/ANALYTICS_SOURCE_AUDIT.md), and [career feasibility matrix](../archive/research/CAREER_DATA_FEASIBILITY_MATRIX.md) record what each source family can support.
...
The normalized career schema and provenance rules are documented in [CAREER_DATA_SPEC.md](../contracts/CAREER_DATA_SPEC.md). The September 2026 [validation report](../../data/career/reports/validation-report.json) passed with zero errors and one warning. It contains:
...
The live architecture assigns one upstream owner per source family. The [runner](../../scripts/live-runner.mjs), [runner core](../../scripts/lib/live-runner-core.mjs), [API](../../scripts/api-server.mjs), and [runbook](../operations/LIVE_RUNNER_RUNBOOK.md) define lifecycle phases, lock and process-budget guards, cache/archive-first readers, and wrong-series protection.
...
| Isolated live team radio and live #9 POV | Unavailable pending permissioned source | [Audio findings](../archive/source-research/AUDIO_RADIO_FINDINGS.md), [POV findings](../archive/source-research/LIVE_POV_ACCESS_FINDINGS.md) |
| Public race probabilities | Blocked by calibration, forward-validation, and review gates | [ML plan](../archive/research/ML_RESEARCH_PLAN_2026-07-20.md) |
| Causal team, weather, reliability, or setup attribution | Blocked by input and identification limits | [Analytics source audit](../archive/audits/ANALYTICS_SOURCE_AUDIT.md) |
| Archive deletion/compaction policy | Inert configuration; no live deletion | [Retention contract](../operations/ARCHIVE_V2_RETENTION.md) |
| Apple TV/tvOS product | Roadmap only | [tvOS roadmap](../archive/source-research/APPLE_TV_TVOS_ROADMAP.md) |
...
- **Process exhaustion:** overlapping collectors motivated single-ingestor ownership; see the [RCA](../archive/live-drills/LIVE_DRILL_PROCESS_EXHAUSTION_RCA_2026-06-21.md).

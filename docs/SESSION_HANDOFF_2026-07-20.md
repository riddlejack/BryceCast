...
`docs/EXECUTION_CHARTER_2026-07-20.md` (the operating contract),
`docs/FABLE_LESSONS.md` (updated), and the task board in this session.
...
1. **docs/drafts/RACETOOLS_EMAIL_2026-07-20.md** — send it (provenance
   line, 3 defect replacements, both map asks, the 2026-logs question).
2. **docs/drafts/CGR_OUTREACH_2026-07-20.md** — the text for Bryce.
3. **docs/ML_RESEARCH_PLAN_2026-07-20.md** — adversarially reviewed and

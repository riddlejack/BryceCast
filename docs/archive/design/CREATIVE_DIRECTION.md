...
Full detail in docs/archive/handoffs/PAGECRAFT_HANDOFF_2026-07-12.md §2. Headlines: add gold
...
docs/archive/design/DESIGN_TASTE.md, then **docs/archive/handoffs/PAGECRAFT_HANDOFF_2026-07-12.md** (state,

...
were superseded on 2026-07-11 by docs/archive/design/DESIGN_TASTE.md — light, system-font,
...
`docs/contracts/UI_ANALYTICS_PRODUCT_CONTRACT.md` and `docs/contracts/LIVE_RACE_DAY_PRODUCT_CONTRACT.md`
remain binding.

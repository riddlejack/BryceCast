...
- BryceCast source boundary and current architecture: `docs/archive/audits/READINESS.md`, `docs/archive/source-research/SOURCE-INVENTORY.md`, `docs/archive/source-research/POV_ESCALATION_LADDER.md`

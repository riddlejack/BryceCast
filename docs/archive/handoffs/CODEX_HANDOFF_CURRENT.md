...
At that time, `docs/archive/handoffs/PHASE3_HANDOFF_2026-07-19.md` superseded the July 18 status
...
- The post-weekend content-addressed archive redesign is specified in `docs/archive/research/LIVE_ARCHIVE_V2_PLAN.md`. Keep one-second timing, version enrichment payloads by content hash, migrate through a sidecar database, and do not modify or vacuum the active legacy archive.
...
and 8 GB Mac mini ideas are recorded in `docs/archive/design/LIVE_PRODUCT_IDEAS.md`; do not
...
- `docs/archive/research/CAREER_DATA_FEASIBILITY_MATRIX.md`
- `docs/archive/research/CAREER_RESEARCH_WORKSTREAMS.md`
- `docs/archive/handoffs/PARALLEL_INGESTION_COORDINATION.md`
...
15. `docs/archive/audits/INDY_NXT_DASHBOARD_READINESS.md` was the June UI-facing contract. It listed production-safe INDY NXT analytics, caveats, and categories that had to stay out of production copy.
16. For live UI work, read `docs/archive/audits/LIVE_DATA_READINESS_AUDIT.md`, `docs/operations/API_SERVICE.md`, `docs/archive/source-research/SOURCE-INVENTORY.md`, and `docs/archive/audits/ANALYTICS_SOURCE_AUDIT.md` before designing screens. They define the live-source catalog, `/api/*` contracts, weather readiness, wrong-series guards, and fields that remain unavailable.

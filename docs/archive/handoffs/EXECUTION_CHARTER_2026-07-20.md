...
resuming mid-run reads THIS, the task board, and `docs/archive/handoffs/FABLE_LESSONS.md`
...
2. **Codex (gpt-5.6-sol, xhigh) design-review pass** on the work product —
   ...
   framed as a second set of taste eyes. Review against: `docs/archive/design/DESIGN_TASTE.md`
   (the blacklist is law), `docs/archive/design/CREATIVE_DIRECTION.md`, the dataviz skill
...
the ML plan (`docs/archive/research/ML_RESEARCH_PLAN_2026-07-20.md`) is handed to a

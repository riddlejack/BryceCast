...
dump in `docs/archive/handoffs/PHASE3_HANDOFF_2026-07-19.md`, shaped per the house rule — data
...
the July 12 charter's Global Rules + Reading Order and `docs/archive/design/DESIGN_TASTE.md`.

...
`docs/archive/handoffs/PHASE3_EXECUTION_CHARTER_2026-07-18.md` (the queue) and
`docs/archive/handoffs/CODEX_EXECUTION_CHARTER_2026-07-12.md` (the worker rules).
...
- Whimsy is welcome; slop is banned (`docs/archive/design/DESIGN_TASTE.md` blacklist is

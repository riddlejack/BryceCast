...
`docs/archive/design/CREATIVE_DIRECTION.md`, and `docs/archive/design/DESIGN_TASTE.md` — those still rule.
...
- Repo: the BryceCast working copy (Bryce Aron INDY NXT companion app), branch
  ...
  docs/archive/design/CREATIVE_DIRECTION.md, docs/archive/design/DESIGN_TASTE.md, then
  docs/archive/handoffs/PAGECRAFT_HANDOFF_2026-07-12.md (the full state + Jack's latest

...
2. `docs/archive/design/CREATIVE_DIRECTION.md` — the design constitution: locked decisions,
   editorial POV, shipped patterns, McKinsey chart lessons, magic backlog.
3. `docs/archive/design/DESIGN_TASTE.md` — the visual system + the AI-slop blacklist. If a
   pattern on the blacklist appears in your diff, the diff is wrong.
4. `docs/archive/handoffs/PAGECRAFT_HANDOFF_2026-07-12.md` — §4 working method, §5 gotchas
...
- Server: a replay module in the API service (`docs/operations/API_SERVICE.md` first).
...
1. Codex executes a brief end-to-end, self-reviews against
   `docs/archive/design/DESIGN_TASTE.md` blacklist + this charter, runs

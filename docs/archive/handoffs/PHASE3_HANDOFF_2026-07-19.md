...
- **The live-runtime checkout** (`~/Documents/Bryce POV access`) is still
  ...
  capture archives per `docs/archive/research/LIVE_ARCHIVE_V2_PLAN.md`).
...
(docs/operations/DEPLOY_RUNBOOK.md production-truth section); §3's two branches and
§4's pipeline items 1–6 are ALL merged/shipped; §5's brain dump became
Briefs O–T (docs/archive/handoffs/PHASE3_BRIEFS_O_T_2026-07-19.md) and shipped through
...
REWRITTEN as docs/archive/research/ML_RESEARCH_PLAN_2026-07-20.md). The atlas's "2 per

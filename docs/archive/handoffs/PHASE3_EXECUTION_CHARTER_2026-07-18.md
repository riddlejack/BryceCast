...
- **Opus 4.8 workers (default executor):** launch background agents with the
  ...
  `docs/archive/handoffs/CODEX_EXECUTION_CHARTER_2026-07-12.md` (Global Rules + Reading Order
...
- Canonical trunk: **`master`** (see `docs/archive/handoffs/CODEX_HANDOFF_CURRENT.md`, whose
...
`docs/archive/design/CREATIVE_DIRECTION.md`, `docs/archive/design/DESIGN_TASTE.md`,
`docs/archive/handoffs/CODEX_EXECUTION_CHARTER_2026-07-12.md`,
...
memory first, then docs/archive/handoffs/CODEX_HANDOFF_CURRENT.md (July 18 section is
controlling for repo/runtime state), then
docs/archive/handoffs/PHASE3_EXECUTION_CHARTER_2026-07-18.md — that charter is your work
...
3. **Permission lane (new, non-engineering).** No downloading, ingesting,
   ...
   (Fable-level writing task, ties into docs/archive/source-research/OUTREACH.md): ask for full
...
Read with `docs/archive/handoffs/FABLE_LESSONS.md` (the design-judgment inheritance; it is
...
`docs/publication/DATA_PERMISSIONS.md` — the authorization ledger. RaceTools use is

...
Generated: `2026-09-11T01:20:20Z`
Repo head: `f2f69c6`
...
- INDY NXT feature rows: `45`.
- Career prior rows: `68`.
- Context packs: `{'career_lab': 1, 'live_race_day': 1, 'race_debrief': 45, 'upcoming_event': 0}`.

## Predictive Feasibility

- Overall finish-percentile baseline MAE: `0.217`.
- Best observed finish-percentile MAE: `0.202` from `start_position_ridge`.
...
- Upcoming event packs: all 0 remaining INDY NXT events in the current future-prep window.
- Race debrief packs: all 45 analyzable Bryce INDY NXT races.

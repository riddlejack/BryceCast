...
Generated from canonical career dataset updated `2026-07-02T17:41:03.634Z`.
...
| INDY NXT | 38 | 12.395 | -0.947 | 0.456 | 0.105 | 0.474 | 0.132 |
...
| INDY NXT | result_conversion | 38 | production_safe | Use in Career Analytics Lab. | Use percentiles alongside raw finish because field sizes and formats vary by series. |
| INDY NXT | qualifying_conversion | 65 | production_safe | Use in Career Analytics Lab. | Qualifying rows exist; display session-format and group caveats where applicable. |
...
| INDY NXT | weather_context | 104 | source_bounded_partial | Use with coverage badge and denominators. | INDY NXT weather is modeled non-official; context only. |
| INDY NXT | lap_shape | 1428 | source_bounded_partial | Use with coverage badge and denominators. | Lap row grains differ by source family; use within-series first and show coverage denominators. |
| INDY NXT | team_teammate_context | 2966 | source_bounded_partial | Use with coverage badge and denominators. | Full-field results support descriptive team/teammate context, not engineering root-cause attribution. |
| INDY NXT | section_pace | 305 | source_bounded_partial | Use with coverage badge and denominators. | Section metrics are currently INDY NXT-only and need denominator badges for sparse sessions. |
...
| INDY NXT | 38 | 20.8 | reference_model_complete_for_ui_contract |
